...
if "chat_engine" not in st.session_state.keys(): # Initialize the chat engine
       # st.session_state.chat_engine = index.as_chat_engine(chat_mode="condense_question", verbose=True)
        ...
        "{context_str}"
        "\nInstruction: Use the previous chat history, or the context above, to interact and help the user. If no previous chat history, give recommendations closest numerically and semantically to user's specifications."
    ),
    verbose=False,
)
